...
class Net(nn.Module):
    ...
    def forward(self, content, style, alpha=1.0):
        ...
        content_loss = self.calc_content_loss(opt1_feats[-1],content_feats[-1], norm=True) + self.calc_content_loss(opt2_feats[-1], style_feats[-1], norm=True)
        ...
        return output1, rc1, rs1, output2, rc2, rs2, content_transitive_loss, style_transitive_loss, style_diff_loss, content_restoration_loss, style_restoration_loss, content_loss, style_loss
