...
parser.add_argument('--style_dir', type=str, default='./train',
                    help='Directory path to a batch of style images')
parser.add_argument('--save_dir', default='./experiments_round5',
                    help='Directory to save the model')
parser.add_argument('--sample_path', type=str, default='./samples_round5',                     
...
parser.add_argument('--breakpoint_transformer', type=str, default='./experiments_round5/transformer_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint transformer model')
parser.add_argument('--breakpoint_decoder', type=str, default='./experiments_round5/decoder_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint decoder model')
parser.add_argument('--breakpoint_optimizer', type=str, default='./experiments_round5/optimizer_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer model')
parser.add_argument('--breakpoint_optimizer_D1', type=str, default='./experiments_round5/optimizer_D1_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer D1 model')
parser.add_argument('--breakpoint_optimizer_D2', type=str, default='./experiments_round5/optimizer_D2_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer D2 model')
# training options
...
parser.add_argument('--content_transitive_weight', type=float, default=4)
parser.add_argument('--style_transitive_weight', type=float, default=4)
#parser.add_argument('--content_diff_weight', type=float, default=1.0)
parser.add_argument('--style_diff_weight', type=float, default=4)
parser.add_argument('--content_restoration_weight', type=float, default=2)
parser.add_argument('--style_restoration_weight', type=float, default=2)
...
#====================================================
filename = './loss_v5.xlsx'
columns=["content_transitive","style_transitive","style_difference","content_restoration","style_restoration","loss_gan_g1","loss_gan_d1","loss_gan_g2","loss_gan_d2","content_loss","style_loss",
        "total_loss"]
...
for i in tqdm(range(args.start_iter, args.max_iter)):
    ...
    output1, rc1, rs1, output2, rc2, rs2, content_transitive_loss, style_transitive_loss, style_diff_loss, content_restoration_loss, style_restoration_loss, content_loss, style_loss= network(content_images, style_images)
