...
# parser.add_argument('--content_dir', type=str, default='/content/train2014',
#                     help='Directory path to a batch of content images')
# parser.add_argument('--style_dir', type=str, default='/content/train',
#                     help='Directory path to a batch of style images')
# parser.add_argument('--save_dir', default='/content/drive/Shareddrives/Style-Transfer/IEContraAST-main/experiments_round31',
#                     help='Directory to save the model')
# parser.add_argument('--sample_path', type=str, default='/content/drive/Shareddrives/Style-Transfer/IEContraAST-main/samples_round31',                     help='Directory to save the intermediate samples')
# parser.add_argument('--vgg', type=str,default='/content/drive/Shareddrives/Style-Transfer/IEContraAST-main/model/vgg_normalised.pth',                     help='Directory to load the encoder model')
# parser.add_argument('--breakpoint_transformer', type=str, default='/content/drive/Shareddrives/Style-Transfer/IEContraAST-main/experiments_round31/transformer_iter_' + str(break_point) + '.pth', 
#                     help='Directory to load the breakpoint transformer model')
# parser.add_argument('--breakpoint_decoder', type=str, default='/content/drive/Shareddrives/Style-Transfer/IEContraAST-main/experiments_round31/decoder_iter_' + str(break_point) + '.pth', 
#                     help='Directory to load the breakpoint decoder model')
# parser.add_argument('--breakpoint_optimizer', type=str, default='/content/drive/Shareddrives/Style-Transfer/IEContraAST-main/experiments_round31/optimizer_iter_' + str(break_point) + '.pth', 
#                     help='Directory to load the breakpoint optimizer model')
# parser.add_argument('--breakpoint_optimizer_D1', type=str, default='/content/drive/Shareddrives/Style-Transfer/IEContraAST-main/experiments_round31/optimizer_D1_iter_' + str(break_point) + '.pth', 
#                     help='Directory to load the breakpoint optimizer D1 model')
# parser.add_argument('--breakpoint_optimizer_D2', type=str, default='/content/drive/Shareddrives/Style-Transfer/IEContraAST-main/experiments_round31/optimizer_D2_iter_' + str(break_point) + '.pth', 
...
parser.add_argument('--style_dir', type=str, default='./train',
                    help='Directory path to a batch of style images')
parser.add_argument('--save_dir', default='./experiments_round4',
                    help='Directory to save the model')
parser.add_argument('--sample_path', type=str, default='./samples_round4',                     
...
parser.add_argument('--breakpoint_transformer', type=str, default='./experiments_round4/transformer_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint transformer model')
parser.add_argument('--breakpoint_decoder', type=str, default='./experiments_round4/decoder_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint decoder model')
parser.add_argument('--breakpoint_optimizer', type=str, default='./experiments_round4/optimizer_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer model')
parser.add_argument('--breakpoint_optimizer_D1', type=str, default='./experiments_round4/optimizer_D1_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer D1 model')
parser.add_argument('--breakpoint_optimizer_D2', type=str, default='./experiments_round4/optimizer_D2_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer D2 model')
# training options
...
parser.add_argument('--content_transitive_weight', type=float, default=10.0)
parser.add_argument('--style_transitive_weight', type=float, default=10.0)
#parser.add_argument('--content_diff_weight', type=float, default=1.0)
parser.add_argument('--style_diff_weight', type=float, default=10.0)
parser.add_argument('--content_restoration_weight', type=float, default=5)
parser.add_argument('--style_restoration_weight', type=float, default=5)
...
valid = 1
fake = 0
D1 = Adain.MultiDiscriminator()
D1.to(device)

D2 = Adain.MultiDiscriminator()
D2.to(device)

vgg.load_state_dict(torch.load(args.vgg))
vgg = nn.Sequential(*list(vgg.children())[:44])
network = Adain.Net(vgg, decoder)
network.train()
network.to(device)
...
#====================================================
filename = './loss_v4.xlsx'
columns=["content_transitive","style_transitive","style_difference","content_restoration","style_restoration","loss_gan_g1","loss_gan_d1","loss_gan_g2","loss_gan_d2",
        "total_loss"]
...
for i in tqdm(range(args.start_iter, args.max_iter)):
    ...
    output1, rc1, rs1, output2, rc2, rs2, content_transitive_loss, style_transitive_loss, style_diff_loss, content_restoration_loss, style_restoration_loss= network(content_images, style_images)
    ...
    loss1 = loss_gan_g1+ loss_gan_g2
    loss = content_transitive_loss + style_transitive_loss + style_diff_loss + content_restoration_loss + style_restoration_loss + loss1
        ...
        if (i+1) % 5000 == 0:
                ...
                for j in range(len(total_loss_lst)):
                    all_loss.append([content_transitive_loss_lst[j], style_transitive_loss_lst[j], style_diff_loss_lst[j],
                                     ...
                                     style_restoration_loss_lst[j], loss_gan_g1_loss_lst[j], loss_gan_d1_loss_lst[j],
                                     loss_gan_g2_loss_lst[j], loss_gan_d2_loss_lst[j],
                                     total_loss_lst[j]])
