...
# training options
parser.add_argument('--save_dir', default='./experiments_round1',
                    help='Directory to save the model')
parser.add_argument('--sample_path', type=str, default='./samples_round1',                     
...
parser.add_argument('--breakpoint_transformer', type=str, default='./experiments_round1/transformer_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint transformer model')
parser.add_argument('--breakpoint_decoder', type=str, default='./experiments_round1/decoder_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint decoder model')
parser.add_argument('--breakpoint_optimizer', type=str, default='./experiments_round1/optimizer_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer model')
parser.add_argument('--breakpoint_optimizer_D1', type=str, default='./experiments_round1/optimizer_D1_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer D1 model')
parser.add_argument('--breakpoint_optimizer_D2', type=str, default='./experiments_round1/optimizer_D2_iter_' + str(break_point) + '.pth', 
...
for i in tqdm(range(args.start_iter, args.max_iter)):
    ...
    output1, rc1, rs1, output2, rc2, rs2, l_identity1, l_identity2, content_transitive_loss, style_transitive_loss, style_diff_loss, content_restoration_loss, style_restoration_loss= network(content_images, style_images)
