...
# Basic options
parser.add_argument('--content_dir', type=str, default = './coco_test/')
parser.add_argument('--style_dir', type=str, default = './wiki_test/')
...
parser.add_argument('--transform', type=str, default = './experiments_round1/transformer_iter_160000.pth')
