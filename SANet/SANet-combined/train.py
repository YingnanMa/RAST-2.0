...
parser.add_argument('--style_dir', type=str, default='./train',
                    help='Directory path to a batch of style images')
parser.add_argument('--save_dir', default='./experiments_round37',
                    help='Directory to save the model')
parser.add_argument('--sample_path', type=str, default='./samples_round37',                     
...
parser.add_argument('--breakpoint_transformer', type=str, default='./experiments_round37/transformer_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint transformer model')
parser.add_argument('--breakpoint_decoder', type=str, default='./experiments_round37/decoder_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint decoder model')
parser.add_argument('--breakpoint_optimizer', type=str, default='./experiments_round37/optimizer_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer model')
parser.add_argument('--breakpoint_optimizer_D1', type=str, default='./experiments_round37/optimizer_D1_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer D1 model')
parser.add_argument('--breakpoint_optimizer_D2', type=str, default='./experiments_round37/optimizer_D2_iter_' + str(break_point) + '.pth', 
                    help='Directory to load the breakpoint optimizer D2 model')
...
for i in tqdm(range(args.start_iter, args.max_iter)):
    ...
    output1, rc1, rs1, output2, rc2, rs2, l_identity1, l_identity2, content_transitive_loss, style_transitive_loss, style_diff_loss, content_restoration_loss, style_restoration_loss, content_loss, style_loss= network(content_images, style_images)
    ...
    loss1 =l_identity1 * 50 + l_identity2 * 1 + loss_gan_g1+ loss_gan_g2
        ...
        if (i+1) % 5000 == 0:
                ...
                for j in range(len(total_loss_lst)):
                    all_loss.append([content_transitive_loss_lst[j], style_transitive_loss_lst[j], style_diff_loss_lst[j],
                                     ...
                                     loss_gan_g1_loss_lst[j], loss_gan_d1_loss_lst[j],
